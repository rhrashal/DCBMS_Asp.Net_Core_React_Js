      ...
      <div className="row navbar navbar-expand-lg navbar-light bg-light p-2 shadow bg-light rounded">
        ...
        <div className="dropdown">
          ...
          <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <NavLink className="dropdown-item" to="/test-type">
              Test Type
            </NavLink>
        ...
        <div className="dropdown mx-2">
          ...
          <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <NavLink className="dropdown-item" to="/entry">
              Entry
            </NavLink>
        ...
        <div className="dropdown">
          ...
          <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <NavLink className="dropdown-item" to="/test-wise">
              Test Wise
            </NavLink>
            <NavLink className="dropdown-item" to="/type-wise">
              Type Wise
            </NavLink>
            <NavLink className="dropdown-item" to="/unpaid-bill">
              Unpaid Bill
            </NavLink>
          </div>
        </div>
